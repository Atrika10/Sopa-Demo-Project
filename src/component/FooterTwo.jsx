...
function FooterTwo() {
  return (
    <div className=" bg-[#030203] py-20 mt-20" id="contactUs">
      <div className="max-w-6xl mx-auto">
        <div className="px-[3%] mb-4 max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Left side - Newsletter text */}
          <div className="text-center md:text-left">
            <p className="text-gray-300 text-sm font-medium tracking-wider mb-1">
              SUBSCRIBE TO OUR
            </p>
          ...
          <div className="w-full md:w-auto">
            <form className="flex items-center bg-white rounded-full overflow-hidden shadow-lg max-w-md mx-auto md:mx-0">
              ...
              <button
                type="submit"
                className="bg-orange-500 hover:bg-orange-700 text-white px-8 py-4 font-semibold tracking-wider transition-colors duration-200 cursor-pointer"
              >
                SUBMIT
              </button>
            </form>
        ...
        <div className="flex flex-col md:flex-row lg:justify-between p-10 justify-center items-center md:items-start gap-20 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-gray-300 text-sm">+1-212-456-7890</p>
              <p className="text-gray-300 text-sm">contact@pcsglobal.dev</p>
            </div>
          </div>
        </div>
      </div>
